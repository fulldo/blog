...
这里提供一种通过需求分支文件 diff 自动获取迭代需求所关联页面的方法。
...
// 再处理后：
{
  "./pages/user/a.js": ["/user"],
  "./pages/user/b.js": ["/user"],
  "./pages/user/dir/c.js": ["/user"],
  "./common/x.js": ["/user", "./about"],
  "./pages/about/d.js": ["/about"],
  "./pages/about/e.js": ["/about"],
  "./pages/about/dir/f.js": ["/about"],
}
```
